...
public class TablesAssignController implements Initializable {
    ...
    public TablesAssignController(Usuario usuario) throws SQLException {
        currentUser = usuario;
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            for (int i = 0; i <mesas.size() ; i++) {
                ...
                fxmlLoader.setLocation(getClass().getResource("TableAssign.fxml"));
                disponible = true;

                AnchorPane anchorPane = fxmlLoader.load();

                TableAssignController tableController = fxmlLoader.getController();
                tableController.setCurrentUser(currentUser);
                tableController.setCurrentTable(mesas.get(i));
